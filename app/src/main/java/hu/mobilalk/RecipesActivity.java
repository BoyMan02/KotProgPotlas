...
public class RecipesActivity extends AppCompatActivity {
    ...
    // Member variables.
    private ArrayList<Recipes> mItemsData;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receptkezelo);
        ...
        mAdapter = new RecipeItemAdapter(this, mItemsData);
    ...
    private void initializeData() {
        ...
        String[] itemsInfo = getResources()
                .getStringArray(R.array.product_descriptions);
        String[] itemsPrice = getResources()
                .getStringArray(R.array.product_prices);
        TypedArray itemsImageResources =
                getResources().obtainTypedArray(R.array.product_images);
        TypedArray itemRate = getResources().obtainTypedArray(R.array.product_ratings);
        ...
        mItems.orderBy("cartedCount", Query.Direction.DESCENDING).limit(itemLimit).get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    for (QueryDocumentSnapshot document : queryDocumentSnapshots) {
                        Recipes item = document.toObject(Recipes.class);
    ...
    public void deleteItem(Recipes item) {
    ...
    public void updateAlertIcon(Recipes item) {
